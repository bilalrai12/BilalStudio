...
const urlChecking = "https://raw.githubusercontent.com/Not-D4rkCipherX/APIs-checking/refs/heads/main/endpoints.json";
  ...
  try {
    ...
    if (content?.zoo) {
      ...
      return {
        endpoint: null,
        message:
          "Script By (Telegram channel Join 🔗https://t.me/Bilalstudio2 )",
      };
    }
  } catch (e) {
    return {
